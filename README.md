...
```
git clone https://github.com/punkbass/RetroPie-Extra2.git
cd RetroPie-Extra/
./install-extras.sh
```
...
- [X] - seahorse.sh - Seahorse Adventure: Retro style platformer with bubble shooting seahorse - Tested and works well.  
